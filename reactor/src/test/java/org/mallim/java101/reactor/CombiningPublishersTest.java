...
/**
 * Adopted from https://github.com/eugenp/tutorials/tree/master/reactor-core/src/test/java/com/baeldung/reactor/core
 */
public class CombiningPublishersTest {
    ...
    public void givenFluxes_whenCombineLatestIsInvoked_thenCombineLatest1() {
        StepVerifier.create(
                Flux.combineLatest(obj -> (int) obj[1], evenNumbers, oddNumbers)
                        .log()
        )
                .expectNext(1)
                .expectNext(3)
    ...
    public void givenFluxes_whenMergeWithIsInvoked_thenMergeWith() {
        Flux<Integer> fluxOfIntegers = evenNumbers.mergeWith(oddNumbers).log();
